...
const placements = [
  ...
  ["Motown Records", "/images/motown.png", "Photography Placement", "#"],
    ...
    <main className="min-h-screen bg-black text-white">
      <header className="sticky top-0 z-50 border-b border-white/10 bg-black/70 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 md:px-8">
          ...
          <a href="#contact" className="rounded-full bg-white px-5 py-3 text-sm font-medium text-black transition hover:bg-white/85">
            Book Now
          </a>
        </div>
      </header>
      ...
      <section className="mx-auto grid min-h-[88vh] max-w-7xl items-end gap-10 px-5 pb-12 pt-20 md:grid-cols-[1.1fr_.9fr] md:px-8 md:pb-20">
        <div>
          ...
          <div className="mt-9">
            <a href="#contact" className="inline-flex items-center rounded-full bg-white px-7 py-4 text-black transition hover:bg-white/85">
              Book Warhaul <ArrowUpRight className="ml-2 h-4 w-4" />
            </a>
          </div>
        </div>
      ...
      <section id="services" className="bg-white px-5 py-24 text-black md:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12 flex justify-center">
            <a href="#contact" className="inline-flex rounded-full bg-black px-8 py-4 text-sm uppercase tracking-[0.18em] text-white transition hover:bg-black/80">
              Contact Us
            </a>
          </div>
        </div>
      ...
      <section id="studio" className="mx-auto max-w-7xl px-5 py-24 md:px-8">
        ...
        <div className="grid gap-5 md:grid-cols-3">
          <div className="rounded-[2rem] border border-white/10 bg-white/[0.06] p-7">
            ...
            <p className="mt-8 border-t border-white/10 pt-6 text-4xl font-black">$90 / 2hr</p>
            <a href="#contact" className="mt-8 inline-flex rounded-full bg-white px-6 py-4 text-sm uppercase tracking-[0.16em] text-black">Book Studio</a>
          </div>
          ...
          <div className="rounded-[2rem] bg-white p-7 text-black">
            ...
            <p className="mt-4 text-black/60">$20/hr minimum. Add an engineer for $60/hr.</p>
            <p className="mt-8 border-t border-black/10 pt-6 text-4xl font-black">$20/hr</p>
            <a href="#contact" className="mt-8 inline-flex rounded-full bg-black px-6 py-4 text-sm uppercase tracking-[0.16em] text-white">Book Audio</a>
          </div>
          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/[0.06] p-7">
            ...
            <p className="mt-8 border-t border-white/10 pt-6 text-4xl font-black">DJs</p>
            <a href="#contact" className="mt-8 inline-flex rounded-full bg-white px-6 py-4 text-sm uppercase tracking-[0.16em] text-black">Book DJ Space</a>
          </div>
        </div>
      </section>
      ...
      <section id="events" className="mx-auto max-w-7xl px-5 py-24 md:px-8">
        <p className="mb-3 text-xs uppercase tracking-[0.32em] text-white/45">Events</p>
        <h2 className="text-5xl font-black uppercase leading-none tracking-[-0.06em] md:text-7xl">Warhaul Events</h2>

        <div className="mt-14 divide-y divide-white/10 border-y border-white/10">
          {eventSections.map((event) => (
            <details key={event} className="group py-6">
              <summary className="flex cursor-pointer list-none items-center justify-between gap-5">
                <h3 className="text-3xl font-black uppercase tracking-[-0.04em] md:text-5xl">{event}</h3>
              ...
              <div className="mt-8 flex gap-5 overflow-x-auto pb-6">
                {studioImages.map((src, index) => (
                  <img key={`${event}-${index}`} src={src} alt={event} className="h-[360px] min-w-[300px] rounded-[2rem] object-cover md:min-w-[480px]" />
                ))}
              </div>
            </details>
          ))}
      ...
      <section className="bg-white px-5 py-24 text-black md:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-8 text-black/60">
            Selected visual, sonic, photography, styling, cinematography, and audio placements. More visuals and links coming soon.
          </p>
          ...
          <div className="mt-16 grid gap-5 md:grid-cols-3">
            {creditSections.map((section) => (
              <div key={section.title} className="rounded-[2rem] border border-black/10 bg-black p-8 text-white">
                <h3 className={`text-3xl font-black uppercase ${section.color}`}>
                  {section.title}
                </h3>
